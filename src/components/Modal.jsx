...
function Modal() {
  return (
    <div className="fixed inset-0 z-10 flex items-center justify-center py-12 backdrop-blur-sm">
      <div className="no-scrollbar z-20 h-full w-11/12 overflow-y-auto rounded-lg">
